...
export class WordResumeGenerator {
  ...
  generate(resumeContent) {
    ...
    const hasAdditionalInfo =
      (resumeContent.additionalInfo?.languages || resumeContent.languages)?.length > 0 ||
      (resumeContent.additionalInfo?.certifications || resumeContent.certifications)?.length > 0 ||
