    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        {editedContent.skills && editedContent.skills.length > 0 && (
          <div>
            ...
            <p className="text-gray-700">{editedContent.skills.join(", ")}</p>
          </div>
        )}
      ...
      {(editedContent.additionalInfo?.languages?.length > 0 ||
        ...
        <div className="mb-6">
          ...
          {/* Languages */}
          {(editedContent.additionalInfo?.languages?.length > 0 || editedContent.languages?.length > 0) && (
            <div className="mb-3">
              <h4 className="font-semibold text-gray-800">Languages:</h4>
              <p className="text-gray-700">
                {(editedContent.additionalInfo?.languages || editedContent.languages || []).join(", ")}
              </p>
            </div>
          )}

          {/* Certifications */}
          {(editedContent.additionalInfo?.certifications?.length > 0 || editedContent.certifications?.length > 0) && (
            <div className="mb-3">
              <h4 className="font-semibold text-gray-800">Certifications:</h4>
              <div className="space-y-1">
                {(editedContent.additionalInfo?.certifications || editedContent.certifications || []).map((cert, index) => (
                  <div key={index} className="text-gray-700">
                    • {cert}
                  </div>
                ))}
          ...
          {editedContent.additionalInfo?.volunteer?.length > 0 && (
            <div className="mb-3">
              <h4 className="font-semibold text-gray-800">Volunteer Experience:</h4>
              <div className="space-y-1">
    ...
    >
      ...
      <div className="mb-6">
        ...
        <div className="mb-4">
          ...
          <InlineEditableList
            items={editedContent.additionalInfo?.languages || editedContent.languages || []}
            onUpdate={(newItems) => {
              if (editedContent.additionalInfo) {
                updateSection("additionalInfo", { ...editedContent.additionalInfo, languages: newItems });
              } else {
        ...
        <div className="mb-4">
          ...
          <InlineEditableList
            items={editedContent.additionalInfo?.certifications || editedContent.certifications || []}
            onUpdate={(newItems) => {
              if (editedContent.additionalInfo) {
                updateSection("additionalInfo", { ...editedContent.additionalInfo, certifications: newItems });
              } else {
        ...
        <div className="mb-4">
          ...
          <InlineEditableList
            ...
            onUpdate={(newItems) => updateSection("additionalInfo", { ...editedContent.additionalInfo, awards: newItems })}
            sectionName="Award"
          />
        </div>
        ...
        <div className="mb-4">
          ...
          <InlineEditableList
            ...
            onUpdate={(newItems) => updateSection("additionalInfo", { ...editedContent.additionalInfo, volunteer: newItems })}
